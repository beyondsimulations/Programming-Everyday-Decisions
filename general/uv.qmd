...
subtitle: "A beginner-friendly guide using uv"
---
...
You can either:
- Always run scripts with `uv run ...` (safest for beginners), OR
- “Activate” the environment so `python` refers to the project’s Python directly.
...
Explore the official docs later if you’re curious:
