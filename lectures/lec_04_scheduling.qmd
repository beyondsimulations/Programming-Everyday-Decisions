...
:::{.incremental}
1. **Apply** core scheduling algorithms (Johnson's Rule, EDD, SPT) to solve real-world problems
2. **Analyze** trade-offs between different optimization objectives (time, deadlines, priorities)
3. **Connect** scheduling principles to programming concepts and algorithmic thinking
:::
