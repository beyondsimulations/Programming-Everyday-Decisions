...
::: {.callout-note}
Before starting, ensure you have the `pandas` library installed. Depending on your operating system and installation method, you might need to use `pip`, `pip3` or `conda` to install it.
...
assert total_waiting_time == 43, "Total waiting time should be 43"
